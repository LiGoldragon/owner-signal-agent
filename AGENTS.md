# owner-signal-agent agent notes
...
The ordinary `signal-agent` contract exists beside this owner contract. Shared
...
to a shared owner/ordinary surface when the contract shape calls for it.
